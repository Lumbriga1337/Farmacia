...
$sql_vendas_semana = "SELECT DATE(data_venda) as dia, COUNT(*) as total 
                      FROM vendas 
                      WHERE DATE(data_venda) BETWEEN '$data_inicio' AND '$hoje'
...
// Dados para o gráfico de categorias mais vendidas (versão corrigida)
// Consulta corrigida para gráfico de categorias mais vendidas
    ...
    <div class="row quick-actions">
        ...
        <div class="col-md-2 col-6 mb-3">
            <a href="receitas.php" class="quick-action-btn">
                <i class="bi bi-file-earmark-medical quick-action-icon"></i>
                Receitas
            </a>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php
                        $sql_ultimas_vendas = "SELECT v.*, c.nome_cliente as cliente 
                                             FROM vendas v 
...
<script>
    ...
    // Dados para os gráficos (convertidos de PHP para JavaScript)
    const vendasData = {
    ...
    // Renderizar gráficos quando a página carregar
